export const en = {
  ...
  'home.hero.title1': 'Software Engineer.',
  'home.hero.title2': 'Indie Developer.',
  'home.hero.title3': 'Explorer.',
  'home.hero.subtitle': 'Transitioned from finance to code five years ago. From low-level compilers to high-performance backends, from AI Native to full-stack development. I believe in pragmatism, pursuing the balance between "useful" and "usable". Growing through sharing and expression.',
  'home.building': 'Building',
  'home.building.title': 'AI Native Application Exploration',
  'home.building.desc': 'Exploring the possibilities of AI Agents, from AutoGLM to automated testing. Turning wild ideas into reality with code.',
  ...
  'about.intro.title': 'Hello, I\'m Latens',
