            ...
            {navItems.map(item => {
              ...
              return (
                <a
                  key={item.key}
                  href={href}
                  className={`block px-2 py-2 transition-colors relative group no-underline ${active ? 'text-zinc-900 dark:text-zinc-100' : 'hover:text-zinc-900 dark:hover:text-zinc-100'
                    }`}
                >
                  {item.label}
                  <span
                    className={`absolute bottom-1 left-2 h-px bg-zinc-900 dark:bg-zinc-100 transition-all ${active ? 'w-[calc(100%-16px)]' : 'w-0 group-hover:w-[calc(100%-16px)] opacity-50'
                      }`}
                  />
                </a>
              );
              ...
              {navItems.map(item => {
                ...
                return (
                  <a
                    ...
                    className={`block px-6 py-4 rounded-2xl text-lg font-normal transition-colors no-underline ${active
