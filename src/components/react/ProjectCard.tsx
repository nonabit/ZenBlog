  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col grow relative z-10 bg-zinc-50/80 dark:bg-zinc-900/80 backdrop-blur-sm">
        <h3 className="font-heading text-xl font-bold text-zinc-900 dark:text-zinc-100 mb-2 tracking-tight group-hover:text-zinc-700 dark:group-hover:text-zinc-300 transition-colors">
          {data.title}
        </h3>
        ...
        <div className="flex flex-wrap gap-2 mt-auto">
          {data.stack.map((tech) => (
            <span
              ...
              "
            >
              <span className="w-1.5 h-1.5 rounded-full bg-zinc-300 dark:bg-zinc-600 border border-zinc-200 dark:border-zinc-500 group-hover:bg-zinc-500 dark:group-hover:bg-zinc-400 transition-colors"></span>
              {tech}
            </span>
          ))}
        </div>
